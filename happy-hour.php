...
<div id="content">
    ...
    <div id="my_mainContent">
   	<h2>Produse Happy Hour</h2>
    
    	<?php 
		
		$query = "SELECT ID,Denumire,Gramaj,round(Pretul-Pretul*Reducere/100,2) Pretul,Poza FROM PRODUSE WHERE Reducere>0";
